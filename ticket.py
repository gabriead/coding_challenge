...
class TicketAPI:
    ...
    def get_permissions(self):
        ...
        response = requests.get(
            f"{self.host}/api/v1/user_access_token",
    ...
    def create_ticket_with_article(self, title, subject, body_text):
        ...
        reponse_article, status_code = self.create_ticket_article(ticket_id, subject, body_text)
        return response, reponse_article, status_code
